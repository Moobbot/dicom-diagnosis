        ...
        return (
            <React.Fragment>
                <div className="flex flex-wrap" style={{ gap: '8px' }} >
                    <GenericButton label="Thêm tài khoản" icon="pi pi-plus" onClick={openNew} permissions={permissions} style={{ height: '40px' }} severity="info" />
                    <GenericButton label="Khóa tài khoản" icon="pi pi-lock" onClick={confirmDeleteSelected} permissions={permissions} disabled={!selectedUsers || !selectedUsers.length} style={{ height: '40px' }} severity="danger" />
