...
const UserDialog: React.FC<UserDialogProps> = ({
    ...
    return (
        <Dialog visible={visible} style={{ width: '60vw' }} header={isEditing ? 'Sửa tài khoản' : 'Thêm tài khoản'} modal className="p-fluid" footer={
            <React.Fragment>
                <GenericButton label="Cancel" icon="pi pi-times" className="p-button" onClick={onHide} severity="danger"/>
                <GenericButton label="Save" icon="pi pi-check" className="p-button" onClick={onSave} severity="success"/>
            </React.Fragment>
        } onHide={onHide}>
            <div className="grid">
                <div className="col-6">
                ...
                <div className="col-6">
                    <div className="field w-full">
                        ...
                        <InputText
                            ...
                            placeholder={isEditing ? "Enter to change password" : "Enter password"}
                        />
                        {submitted && !isEditing && !user.password && <small className="p-error">Password is required.</small>}
                        {submitted && user.password && user.password.length < 6 && <small className="p-error">Password must be at least 6 characters.</small>}
                    </div>
                </div>
                <div className="col-6">
                    <div className="field w-full">
                        ...
                        />
                        {submitted && !user.detail_user?.name && <small className="p-error">Full name is required.</small>}
                    </div>
                </div>
                <div className="col-6">
                    <div className="field w-full">
                        ...
                        />
                        {submitted && !user.detail_user?.user_code && <small className="p-error">Employee code is required.</small>}
                    </div>
                </div>
                <div className="col-6">
                    <div className="field w-full">
                        ...
                        <MultiSelect
                            ...
                            display="chip"
                        />
                        {submitted && (!user.roles || user.roles.length === 0) && <small className="p-error">Role is required.</small>}
                    </div>
                </div>
                {!isEditing && (
                    <>
                        <div className="col-6">
                            <div className="field w-full">
                                <label htmlFor="detail_user.dob" className="font-bold">Date of birth <span className="text-red-500">*</span></label>
                                <Calendar
                                    id="detail_user.dob"
                                    ...
                                    showIcon
                                />
                                {submitted && !user.detail_user?.dob && <small className="p-error">Date of birth is required.</small>}
                            </div>
                        </div>
                        <div className="col-6">
                            <div className="field w-full">
                                ...
                                />
                                {submitted && user.detail_user.gender === undefined && <small className="p-error">Gender is required.</small>}
                            </div>
                        </div>
                        <div className="col-12 md:col-6">
                            <div className="field w-full">
                                <label htmlFor="detail_user.address" className="font-bold"> Address </label>
                                <InputText
                        ...
                        <div className="col-12">
                            <label htmlFor="upload-image" className='block mb-2'>Avatar</label>
